...
public class DaringBTActionWildApproachPlayer : BTLeaf
{
    ...
    public DaringBTActionWildApproachPlayer(string _name, CreatureAIContext _context) : base(_name, _context) {
        name = _name;
        context = _context;
