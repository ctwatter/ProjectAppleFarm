...
public class EnergeticBTActionWildWanderInLocation : BTLeaf
{
    ...
    public EnergeticBTActionWildWanderInLocation (string _name, CreatureAIContext _context) : base(_name, _context) {
        name = _name;
        context = _context;
        agent = context.agent;
